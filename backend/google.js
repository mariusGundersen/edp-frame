...
export default async function getCalendarEvents(timeMin, timeMax) {
...
function getEvents(calendar, calendarId, timeMin, timeMax) {
  return calendar.events.list({
    ...
    singleEvents: true,
    orderBy: 'startTime'
  }).then(r => r.data.items.map(({ start, end, summary }) => ({
    start,
    end,
    summary
  })));
